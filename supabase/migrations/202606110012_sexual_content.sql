-- Sexual content screening: extends the server-side guardian. Deliberately
-- narrow — bare expletives are late-night vocabulary, not sexual content;
-- only unambiguous terms and solicitations flag. Same enforcement path as
-- 202606110010/11: flagged content can never become public. Mirrors
-- src/lib/signalModeration.ts; change both together.
